...
public class ImportScriptProcessor extends AbstractProcessor {
	
	public ImportScriptProcessor() {
	}
	...
	public IProcessorMatcher<? extends Node> getMatcher() {
		return new AttributeNameProcessorMatcher("merger","script");
	}
	...
	protected ProcessorResult doProcess(Arguments arguments,
		...
		Text comment = new Text(String.format("<!-- script merger by %s (dev mode)-->", mergerFileName),false);
